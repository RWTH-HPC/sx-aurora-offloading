...
This file implements the class [OmpPragma](Classes/classOmpPragma/), which is used to generate repla- cement pragmas for teams and team combined constructs. 

## Attributes

|                | Name           |
| -------------- | -------------- |
| int | **[ClauseParamCounter](Files/OmpPragma_8cpp/#variable-clauseparamcounter)**  |
