...
This file implements the class [DeclResolver](Classes/classDeclResolver/). 

## Functions

|                | Name           |
| -------------- | -------------- |
| bool | **[isHeaderOpenMPHeader](Files/DeclResolver_8cpp/#function-isheaderopenmpheader)**(llvm::StringRef header_path) |
| bool | **[isDeclInOpenMPHeader](Files/DeclResolver_8cpp/#function-isdeclinopenmpheader)**(clang::Decl * D) |
| llvm::Optional< std::string > | **[getSystemHeaderForDecl](Files/DeclResolver_8cpp/#function-getsystemheaderfordecl)**(clang::Decl * D) |
